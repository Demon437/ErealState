      ...
      >
        ...
        <div className="absolute inset-0 opacity-5">
          <div className="absolute top-0 left-0 w-full h-full"
            style={{
              backgroundImage: `radial-gradient(circle at 25% 25%, #C9A96E 0%, transparent 50%), radial-gradient(circle at 75% 75%, #C9A96E 0%, transparent 50%)`,
            }}
          />
        </div>

        {/* Decorative circles */}
        <div className="absolute -bottom-24 -right-24 w-96 h-96 bg-[#C9A96E]/10 rounded-full" />
        <div className="absolute -top-12 -left-12 w-64 h-64 bg-[#C9A96E]/5 rounded-full" />
        ...
        <div className="relative z-10">
          ...
          <h1 className="text-4xl font-bold text-[#FAF8F4] leading-tight mb-4">
            Manage Your
            <br />
            <span className="text-[#C9A96E]">Real Estate</span>
            <br />
            Portfolio
          </h1>
        ...
        <div className="w-full max-w-md">
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <div className="relative">
                <div className="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
                  <Mail className={cn(
                    ...
                    focusedField === "email" ? "text-[#C9A96E]" : "text-[#9CA3AF]"
                  )} />
                </div>
                <input
                  type="email"
                  ...
                  className={cn(
                    ...
                    focusedField === "email"
                      ? "border-[#C9A96E] ring-3 ring-[#C9A96E]/15 shadow-sm"
                      : "border-[#E6D5C3] hover:border-[#C9A96E]/50"
                  )}
                />
              </div>
            </div>
            ...
            <div>
              ...
              <div className="relative">
                <div className="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
                  <Lock className={cn(
                    "h-4.5 w-4.5 transition-colors duration-200",
                    focusedField === "password" ? "text-[#C9A96E]" : "text-[#9CA3AF]"
                  )} />
                </div>
                <input
                ...
                <button
                  ...
                  className="absolute inset-y-0 right-0 pr-4 flex items-center text-[#9CA3AF] hover:text-[#C9A96E] transition-colors"
                >
            ...
            <motion.button
              ...
              className="w-full flex items-center justify-center gap-2.5 bg-[#1C1B1A] hover:bg-[#C9A96E] text-[#FAF8F4] py-3.5 px-6 rounded-xl font-semibold text-sm transition-all duration-300 shadow-lg hover:shadow-terracotta disabled:opacity-60 disabled:cursor-not-allowed mt-2"
            >
              {loading ? (
                <>
