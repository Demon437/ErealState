        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-3">
            ...
            <button
              ...
              className="px-4 py-2 bg-[#C9A96E] text-white rounded-lg hover:bg-[#C06549]
              ...
              <div>
                ...
                <select
                  ...
                  className="w-full px-3 py-2 border border-gray-300 rounded-md focus:ring-2
                           focus:ring-[#C9A96E] focus:border-transparent"
                >
                  ...
                  <tr key={log._id} className="hover:bg-[#FAF8F4] transition-colors duration-150">
                    ...
                    <td className="px-6 py-4 whitespace-nowrap text-sm font-medium">
                      <button
                        ...
                        className="text-[#C9A96E] hover:text-[#C06549] font-medium"
                      >
