      ...
      <div className="max-w-3xl mx-auto">
        ...
        >
                ...
                {formData.amenities.filter((a) => !AMENITIES_LIST.includes(a)).map((amenity) => (
                  <span key={amenity}
                    ...
                    <button type="button" onClick={() => handleAmenityToggle(amenity)}
                      className="hover:text-[#B89259] transition-colors">
                      <X size={13} />
                    </button>
                  </span>
                ))}
          ...
          <div className="bg-white rounded-2xl p-6 border border-[#E6D5C3] shadow-card">
            ...
            {previewUrls.length < 4 && (
              <label htmlFor="images"
                className="flex flex-col items-center justify-center w-full h-36 border-2 border-dashed border-[#E6D5C3] rounded-xl cursor-pointer bg-[#FAF8F4] hover:border-[#C9A96E] hover:bg-[#C9A96E]/5 transition-all duration-200 group">
                <Upload className="w-8 h-8 text-[#9CA3AF] group-hover:text-[#C9A96E] mb-2 transition-colors" />
          ...
          <motion.button
            ...
            className="w-full py-4 bg-[#1C1B1A] hover:bg-[#C9A96E] text-[#FAF8F4] rounded-xl font-semibold text-base transition-all duration-300 shadow-lg hover:shadow-terracotta disabled:opacity-60 disabled:cursor-not-allowed"
          >
