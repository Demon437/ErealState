          ...
          {error && !loading && (
            <div className="flex items-center justify-center py-24">
              <div className="text-center">
                <span className="material-icons text-4xl text-[#C9A96E] mb-4">error_outline</span>
                <p className="font-manrope text-[#374151] mb-4">{error}</p>
                <button
                  onClick={() => window.location.reload()}
                  className="bg-[#C9A96E] text-white font-manrope font-bold px-6 py-2 rounded-lg hover:bg-[#B89259] transition-all"
                >
                  Retry
                </button>
              </div>
