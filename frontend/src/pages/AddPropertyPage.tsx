  ...
  if (isLoading) {
    return (
      <div className="min-h-screen flex items-center justify-center bg-[#FAF8F4]">
        <div className="w-12 h-12 border-4 border-[#B89259] border-t-transparent rounded-full animate-spin" />
      </div>
    );
  }
    ...
    return (
      <div className="min-h-screen pt-20 bg-[#FAF8F4]">
        ...
        <div className="max-w-xl mx-auto px-4 py-24 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-3 justify-center pt-20 ">
            <Link
              to="/my-listings"
              className="bg-[#B89259] text-white font-manrope font-semibold px-6 py-3 rounded-lg hover:bg-[#B89259] transition-colors"
            >
              View My Listings
            </Link>
            <Link
              to="/properties"
              className="border border-[#B89259] text-[#B89259] font-manrope font-semibold px-6 py-3 rounded-lg hover:bg-[#B89259] hover:text-white transition-colors"
            >
              Browse Properties
            </Link>
          </div>
      ...
      <div className="max-w-3xl mx-auto px-4 sm:px-6 py-12">
        ...
        <form onSubmit={handleSubmit} className="space-y-8">
          ...
          <section className="bg-white border border-[#E6E0DA] rounded-2xl p-6 space-y-5">
            ...
            <div>
              ...
              <input
                ...
                className="w-full border border-[#E6E0DA] rounded-lg px-4 py-2.5 font-manrope text-sm text-[#221410] focus:outline-none focus:ring-2 focus:ring-[#B89259]/40 focus:border-[#B89259]"
              />
            </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div>
                ...
                <select
                  ...
                  onChange={handleChange}
                  required
                  className="w-full border border-[#E6E0DA] rounded-lg px-4 py-2.5 font-manrope text-sm text-[#221410] focus:outline-none focus:ring-2 focus:ring-[#B89259]/40 focus:border-[#B89259] bg-white"
                >
          ...
          <section className="bg-white border border-[#E6E0DA] rounded-2xl p-6 space-y-5">
            ...
            <div>
              ...
              <textarea
                ...
                className="w-full border border-[#E6E0DA] rounded-lg px-4 py-2.5 font-manrope text-sm text-[#221410] focus:outline-none focus:ring-2 focus:ring-[#B89259]/40 focus:border-[#B89259] resize-none"
              />
            </div>
                ...
                return (
                  <label
                    ...
                    className={`flex items-center gap-2 p-3 rounded-lg border cursor-pointer transition-colors select-none ${
                      checked
                        ? 'border-[#B89259] bg-[#B89259]/5 text-[#B89259]'
                        : 'border-[#E6E0DA] text-[#374151] hover:border-[#B89259]/50'
                    }`}
                  >
                    <input
                      type="checkbox"
                    ...
                    <span
                      className={`w-4 h-4 rounded border flex-shrink-0 flex items-center justify-center ${
                        checked ? 'bg-[#B89259] border-[#B89259]' : 'border-[#D4CEC8]'
                      }`}
                    >
                      {checked && (
          ...
          <section className="bg-white border border-[#E6E0DA] rounded-2xl p-6">
              ...
              <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 mb-4">
                {previews.map((src, idx) => (
                  <div key={idx} className="relative group rounded-lg overflow-hidden aspect-square border border-[#E6E0DA]">
                    ...
                    {idx === 0 && (
                      <span className="absolute bottom-1 left-1 bg-[#B89259] text-white font-manrope text-xs px-2 py-0.5 rounded">
                        Cover
                      </span>
                    )}
                  </div>
            ...
            {images.length < 4 && (
              <button
                ...
                className="flex items-center gap-2 border-2 border-dashed border-[#B89259]/40 rounded-lg px-6 py-4 text-[#B89259] font-manrope text-sm hover:border-[#B89259] hover:bg-[#B89259]/5 transition-colors"
              >
          ...
          <button
            type="submit"
            disabled={submitting}
            className="w-full bg-[#B89259] text-white font-manrope font-semibold text-base py-3.5 rounded-xl hover:bg-[#B89259] transition-colors disabled:opacity-60 disabled:cursor-not-allowed"
          >
            {submitting ? (
