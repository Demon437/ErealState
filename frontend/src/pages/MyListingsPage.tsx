    ...
    return (
      <div className="min-h-screen pt-20 bg-[#FAF8F4]">
        ...
        <div className="max-w-xl mx-auto px-4 py-24 text-center">
          ...
          <Link
            to="/add-property"
            className="inline-block bg-[#C9A96E] text-white font-manrope font-semibold px-8 py-3 rounded-xl hover:bg-[#B89259] transition-colors"
          >
            + List a Property
          </Link>
        </div>
    ...
    <div className="min-h-screen pt-20 bg-[#FAF8F4]">
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 py-12">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-8">
          ...
          <Link
            to="/add-property"
            className="inline-flex items-center gap-2 bg-[#C9A96E] text-white font-manrope font-semibold px-5 py-2.5 rounded-xl hover:bg-[#B89259] transition-colors self-start sm:self-auto"
          >
                ...
                <div className="flex-1 p-5 flex flex-col justify-between gap-3">
                  <div>
                    ...
                    <div className="flex flex-wrap gap-3 font-manrope text-sm text-[#374151]">
                      <span className="font-semibold text-[#C9A96E]">{formatPrice(listing.price)}</span>
                      <span>·</span>
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      {listing.status === 'active' && (
                        <Link
                          ...
                          className="font-manrope text-xs font-medium text-[#C9A96E] hover:underline"
                          target="_blank"
                      ...
                      <Link
                        ...
                        className="flex items-center gap-1.5 font-manrope text-xs font-semibold text-[#374151] border border-[#E6E0DA] px-3 py-1.5 rounded-lg hover:border-[#C9A96E] hover:text-[#C9A96E] transition-colors"
                      >
