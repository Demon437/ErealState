      ...
      <div className="bg-white min-h-screen pt-20">
        ...
        <div className="flex items-center justify-center py-32">
          <div className="text-center">
            <span className="material-icons text-5xl text-[#C9A96E] mb-4">error_outline</span>
            <p className="font-manrope text-xl text-[#374151] mb-4">{error || 'Property not found'}</p>
            <Link
              to="/properties"
              className="bg-[#C9A96E] text-white font-manrope font-bold px-8 py-3 rounded-lg hover:bg-[#B89259] transition-all inline-block"
            >
              Back to Properties
            </Link>
          </div>
