...
const AIAnalysisPanel: React.FC<Props> = ({ analysis, loading, error, city }) => {
  ...
  return (
    <div className="bg-white border border-[#E6E0DA] rounded-2xl p-6 space-y-5 mt-15">
      {/* ── Header ───────────────────────────────────── */}
      <div className="flex items-center gap-3">
        <div className="w-9 h-9 bg-[#C9A96E]/10 border border-[#C9A96E]/20 rounded-full flex items-center justify-center shrink-0">
      ...
      {analysis.best_value && (
        <div className="relative bg-gradient-to-br from-[#221410] via-[#3d2519] to-[#221410] overflow-hidden rounded-xl p-5 flex flex-col gap-3 shadow-lg">
          ...
          <div className="flex items-center gap-2.5 relative z-10">
            ...
            <span className="font-space-mono text-[10px] text-[#C9A96E] uppercase tracking-widest font-bold flex items-center gap-1.5">
              <span className="w-1.5 h-1.5 rounded-full bg-[#C9A96E] animate-pulse inline-block" />
              Best Value Pick
            </span>
          </div>
