    ...
    <section className="bg-[#F2EFE9] py-24">
      <div className="max-w-[1280px] mx-auto px-8">
        ...
        <div className="flex items-center justify-between mb-10">
          ...
          <button className="font-space-mono text-sm text-[#221410] border-b border-[#221410] hover:text-[#C9A96E] hover:border-[#C9A96E] transition-colors pb-1">
            View All → See more
          </button>
        </div>
          ...
          {properties.map((property) => (
            ...
            >
              ...
              <div className="relative aspect-[382/286.5] overflow-hidden">
                ...
                {/* Badge */}
                <div className="absolute top-4 left-4 bg-[#C9A96E] text-white font-space-mono text-xs px-3 py-1.5 rounded-full shadow-lg">
                  {property.badge}
                </div>
