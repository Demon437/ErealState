      ...
      <div className="relative w-full max-w-lg bg-[#1a0f0a] border border-white/10 rounded-2xl shadow-2xl overflow-hidden">
        ...
        <div className="flex items-center justify-between px-6 pt-6 pb-4 border-b border-white/10">
          <div className="flex items-center gap-3">
            <div className="w-9 h-9 bg-[#C9A96E]/20 rounded-xl flex items-center justify-center">
        ...
        <div className="mx-6 mb-4 flex items-start gap-2 bg-white/[0.04] border border-white/10 rounded-xl px-4 py-3">
          <AlertCircle className="w-4 h-4 text-[#C9A96E] shrink-0 mt-0.5" />
        ...
        <div className="flex items-center gap-3 px-6 pb-6">
          <button
            ...
            className="flex-1 flex items-center justify-center gap-2 bg-[#C9A96E] hover:bg-[#C05621] disabled:opacity-40 disabled:cursor-not-allowed text-white font-manrope font-semibold text-sm py-3 rounded-xl transition-all"
          >
  ...
  <div>
    <div className="flex items-center justify-between mb-1.5">
      ...
      <a href={linkHref} target="_blank" rel="noopener noreferrer"
        className="flex items-center gap-1 font-manrope text-[11px] text-[#C9A96E] hover:text-[#e88a6f] transition-colors">
        {linkText} <ExternalLink className="w-3 h-3" />
      </a>
    </div>
    <div className="relative bg-white/[0.07] border border-white/10 rounded-xl px-4 py-3 flex items-center gap-3 focus-within:border-[#C9A96E]/50 transition-all">
      <Key className="w-4 h-4 text-[#C9A96E]/60 shrink-0" />
      <input
