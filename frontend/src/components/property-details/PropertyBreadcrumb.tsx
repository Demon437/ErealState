    ...
    <div className="bg-white border-b border-[#E6E0DA]">
      <div className="max-w-[1280px] mx-auto px-8 py-6">
        <div className="flex items-center justify-between">
          ...
          <button 
            onClick={() => navigate(-1)}
            className="flex items-center gap-2 text-[#64748B] hover:text-[#C9A96E] transition-colors group"
          >
          ...
          <nav className="flex items-center gap-2 text-xs tracking-wider uppercase opacity-80">
            <Link to="/" className="font-manrope font-extralight text-[#64748B] hover:text-[#C9A96E] transition-colors">
              Home
            </Link>
            <span className="font-manrope text-[#CBD5E1]">
              /
            </span>
            <Link to="/properties" className="font-manrope font-extralight text-[#64748B] hover:text-[#C9A96E] transition-colors">
              Properties
            </Link>
            <span className="font-manrope text-[#CBD5E1]">
              /
