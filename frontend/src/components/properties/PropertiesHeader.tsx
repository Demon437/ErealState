...
const PropertiesHeader: React.FC<PropertiesHeaderProps> = ({ 
  ...
  return (
<div className="border-b border-[#E6E0DA] bg-white sticky top-[5rem] z-10">
          ...
          <div className="flex items-center gap-4">
            ...
            <div className="flex items-center gap-2">
              ...
              <select
                ...
                className="bg-white border border-[#E6E0DA] rounded-lg px-4 py-2 font-manrope text-sm text-[#221410] cursor-pointer focus:outline-none focus:border-[#C9A96E] appearance-none pr-8 bg-no-repeat bg-right"
                style={{
            ...
            <div className="flex items-center gap-1 bg-[#F8F6F6] rounded-lg p-1">
              <button
                ...
                className={`p-2 rounded transition-all ${
                  viewMode === 'grid'
                    ? 'bg-white text-[#C9A96E] shadow-sm'
                    : 'text-[#6B7280] hover:text-[#C9A96E]'
                }`}
                title="Grid View"
              >
