...
function NotFoundPage() {
  return (
    <PageTransition className="min-h-screen flex flex-col items-center justify-center bg-[#FAF8F4]">
      <h1 className="font-fraunces text-6xl font-bold text-[#C9A96E] mb-4">404</h1>
      <p className="font-manrope text-xl text-[#374151] mb-8">Page not found</p>
      <a href="/" className="bg-[#C9A96E] text-white font-manrope font-bold px-8 py-3 rounded-lg hover:bg-[#B89259] transition-all">
        Go Home
      </a>
    </PageTransition>
  );
