...
<head>
  ...
  <style>
    *{margin:0;padding:0;box-sizing:border-box}
    ...
    .ep{display:flex;align-items:center;justify-content:space-between;padding:12px 16px;background:#FAF8F4;border-radius:8px;border-left:3px solid #C9A96E;margin-bottom:8px;transition:background .15s}
    ...
    .ftr a{color:#C9A96E;text-decoration:none;font-weight:500}
